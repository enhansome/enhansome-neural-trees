# Awesome Neural Tree Papers with stars
...
* ***Hierarchical multi-label classification using local neural networks***
  ...
  * **"Your "Flamingo" is My "Bird": Fine-Grained, or Not"**, CVPR, 2021
    * [\[Paper\]](https://openaccess.thecvf.com/content/CVPR2021/html/Chang_Your_Flamingo_is_My_Bird_Fine-Grained_or_Not_CVPR_2021_paper.html) [\[Code\]](https://github.com/PRIS-CV/Fine-Grained-or-Not) ⭐ 66 | 🐛 1 | 🌐 Python | 📅 2023-09-27
...
* ***Interactions between different branches***
  ...
  * **"Label Relation Graphs Enhanced Hierarchical Residual Network for Hierarchical Multi-Granularity Classification"**, CVPR, 2022
    * [\[Paper\]](https://openaccess.thecvf.com/content/CVPR2022/html/Chen_Label_Relation_Graphs_Enhanced_Hierarchical_Residual_Network_for_Hierarchical_Multi-Granularity_CVPR_2022_paper.html) [\[Code\]](https://github.com/MonsterZhZh/HRN) ⭐ 60 | 🐛 4 | 🌐 Python | 📅 2022-03-24
...
* ***Predict at each grain separately, *i.e.*, first take a model pre-trained on one level, then tune it using labels from other levels***
  * **"Coherent Hierarchical Multi-Label Classification Networks"**, NIPS, 2020
    * [\[Paper\]](https://proceedings.neurips.cc/paper/2020/hash/6dd4e10e3296fa63738371ec0d5df818-Abstract.html) [\[Code\]](https://github.com/EGiunchiglia/C-HMCNN) ⭐ 90 | 🐛 1 | 🌐 Python | 📅 2023-05-04
...
* ***Utilize the hierarchical constraints directly***
  ...
  * **"Large-Scale Object Classification Using Label Relation Graphs"**, ECCV, 2018
    * [\[Paper\]](https://link.springer.com/chapter/10.1007/978-3-319-10590-1_4) [\[Code\]](https://github.com/kylemin/HEX-graph) ⭐ 19 | 🐛 1 | 🌐 Matlab | 📅 2017-07-06
...
* ***DeViSE method that utilizes unannotated Wikipedia text***
  * **"DeViSE: A Deep Visual-Semantic Embedding Model"**, NIPS, 2013
    * [\[Paper\]](https://proceedings.neurips.cc/paper/2013/hash/7cce53cf90577442771720a370c3c723-Abstract.html) [\[Code\]](https://github.com/jean4599/DeViSE) ⭐ 18 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2018-01-15
    * Andrea Frome *et al.*
...
* ***Embeddings whose pair-wise dot products correspond to semantic similarity between classes***
  * **"Hierarchy-Based Image Embeddings for Semantic Image Retrieval"**, WACV, 2019
    * [\[Paper\]](https://ieeexplore.ieee.org/abstract/document/8658633) [\[Code\]](https://github.com/cvjena/semantic-embeddings) ⭐ 268 | 🐛 1 | 🌐 Python | 📅 2021-04-26
...
* **Employ the entailment cones to learn order-preserving embeddings**
  * **"Hierarchical Image Classification Using Entailment Cone Embeddings"**, CVPR, 2020
    * [\[Paper\]](https://openaccess.thecvf.com/content_CVPRW_2020/html/w50/Dhall_Hierarchical_Image_Classification_Using_Entailment_Cone_Embeddings_CVPRW_2020_paper.html) [\[Code\]](https://github.com/ankitdhall/learning_embeddings) ⭐ 22 | 🐛 13 | 🌐 Python | 📅 2023-02-02
    * Ankit Dhall *et al.*
...
* ***Bigot NDTs with pure leaves***
  ...
  * **"NBDT: Neural-Backed Decision Trees"**, ICCV, 2020
    * [\[Paper\]](https://arxiv.org/abs/2004.00221) [\[Code\]](https://github.com/alvinwan/nbdt-pytorch-image-models) ⭐ 16 | 🐛 0 | 🌐 Python | 📅 2020-09-18
...
* ***Bigot NDTs with determined leaf distributions***
  * **"Distilling a Neural Network Into a Soft Decision Tree"**, AI\*IA, 2017
    * [\[Paper\]](https://arxiv.org/abs/1711.09784) [\[Code\]](https://github.com/kimhc6028/soft-decision-tree) ⭐ 306 | 🐛 13 | 🌐 Python | 📅 2018-12-23
  ...
  * **"Deep Neural Decision Forests"**, ICCV, 2015
    * [\[Paper\]](https://openaccess.thecvf.com/content_iccv_2015/html/Kontschieder_Deep_Neural_Decision_ICCV_2015_paper.html) [\[Code\]](https://github.com/jingxil/Neural-Decision-Forests) ⭐ 166 | 🐛 1 | 🌐 Python | 📅 2019-06-28
  ...
  * **"Deep Regression Forests for Age Estimation"**, CVPR, 2018
    * [\[Paper\]](https://openaccess.thecvf.com/content_cvpr_2018/html/Shen_Deep_Regression_Forests_CVPR_2018_paper.html) [\[Code\]](https://github.com/Sakura03/age_trans) ⭐ 9 | 🐛 0 | 🌐 Python | 📅 2019-02-11
  ...
  * **"Neural Prototype Trees for Interpretable Fine-Grained Image Recognition"**, CVPR, 2021
    * [\[Paper\]](https://openaccess.thecvf.com/content/CVPR2021/html/Nauta_Neural_Prototype_Trees_for_Interpretable_Fine-Grained_Image_Recognition_CVPR_2021_paper.html?ref=https://githubhelp.com) [\[Code\]](https://github.com/M-Nauta/ProtoTree) ⭐ 111 | 🐛 4 | 🌐 Python | 📅 2022-06-30
...
* ***Expert NDTs with architecture search phase***
  * **"Adaptive Neural Trees"**, ICML, 2019
    * [\[Paper\]](http://proceedings.mlr.press/v97/tanno19a.html?utm_campaign=piqcy\&utm_medium=email\&utm_source=Revue%20newsletter) [\[Code\]](https://github.com/rtanno21609/AdaptiveNeuralTrees) ⭐ 156 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2019-07-03
  ...
  * **"Self-Born Wiring for Neural Trees"**, ICCV, 2021
    * [\[Paper\]](https://openaccess.thecvf.com/content/ICCV2021/html/Chen_Self-Born_Wiring_for_Neural_Trees_ICCV_2021_paper.html) [\[Code\]](https://github.com/HollyLee2000/SeBoW-paddle) ⭐ 11 | 🐛 0 | 🌐 Python | 📅 2021-12-10
